          ...
          <div className="mt-6">
            <div className="col-12 flex items-center justify-center">
              <div className='profile-group flex items-center justify-center flex-col min-w-[600px]'>
                <div className='text-[#1E2328] font-[500] landing-[19px] text-[29px]'>
                  Change Password
                </div>
                {/*------- Form start ------*/}
                <div className="mt-10 w-full">
                  <form>
                    <div>
                      ...
                      <div className="form-control mt-3">
                        ...
                        <div className="orm-control flex flex-row items-center rounded-[15px] h-14 bg-white px-3 shadow">
                          <input
                    ...
                    <div className="mt-6">
                      <button
                        type="submit"
                        className="btn text-white gap-2 bg-[#000] btn-block rounded-md mt-4 hover:bg-black text-[17px] font-[500] landing-[19px]"
                  ...
                  <div className='passlink text-center m-8'>
                    <Link to="/" className="text-[#6B6B6B] dark:white text-[17px] font-[500] landing-[19px] ">
                      Go To My Profile
                    </Link>
                  </div>
                </div>
