  ...
  return (
    <div className="sticky top-0 z-50 bg-white">
      <div
        role="navigation"
        aria-label="Navbar"
        className="navbar border-base-200 p-6 shadow"
      >
        <div className="gap-3 navbar-start">
          ...
          >
            ...
            >
              <path
                d="M10 1.5C10 0.671573 9.32843 0 8.5 0H1.5C0.671573 0 0 0.671573 0 1.5C0 2.32843 0.671573 3 1.5 3H8.5C9.32843 3 10 2.32843 10 1.5Z"
                fill="black"
              />
              <path
                d="M21 9.5C21 8.67157 20.3284 8 19.5 8H1.5C0.671574 8 0 8.67157 0 9.5C0 10.3284 0.671574 11 1.5 11H19.5C20.3284 11 21 10.3284 21 9.5Z"
                fill="black"
              />
              <path
                d="M17 17.5C17 16.6716 16.3284 16 15.5 16H1.5C0.671574 16 0 16.6716 0 17.5C0 18.3284 0.671574 19 1.5 19H15.5C16.3284 19 17 18.3284 17 17.5Z"
                fill="black"
              />
            </svg>
          </button>
        ...
        <div className="gap-3 navbar-end">
                ...
                <div className="mt-3">
                  <div className="my-0.5 flex cursor-pointer items-center gap-3 rounded-box p-1.5 transition-all hover:bg-base-content/5 active:scale-[.98]">
                    <img
                      ...
                      width="128"
                      height="128"
                      srcSet="/images/avtar-1.avif 1x, /images/avtar-1.avif 2x"
                      src="/images/avtar-1.avif"
                      alt="avtar-error"
                      decoding="async"
                      data-nimg="1"
                ...
                <div className="mt-3">
                  <div className="my-0.5 flex cursor-pointer items-center gap-3 rounded-box p-1.5 transition-all hover:bg-base-content/5 active:scale-[.98]">
                    <img
                      ...
                      width="128"
                      height="128"
                      srcSet="/images/avtar-2.avif 1x, /images/avtar-2.avif 2x"
                      src="/images/avtar-2.avif"
                      alt="avtar-error"
                      decoding="async"
                      data-nimg="1"
                      className="size-9 bg-base-content/10 p-0.5 mask mask-circle"
                ...
                <div className="mt-3">
                  <div className="my-0.5 flex cursor-pointer items-center gap-3 rounded-box p-1.5 transition-all hover:bg-base-content/5 active:scale-[.98]">
                    <img
                      ...
                      width="128"
                      height="128"
                      srcSet="/images/avtar-3.avif 1x, /images/avtar-3.avif 2x"
          ...
          <div className="dropdown dropdown-bottom dropdown-endc ml-3">
            ...
            >
              <div className="flex items-center gap-2">
                <div className="flex flex-col items-end">
                  <p className="light:text-[#1E2328B2] dark:text-red-800 text-[18px] landing[19] font[500]">
                    {" "}
                    Harwinder Kaur
                  </p>
            ...
            <ul
              tabIndex="0"
              className="dropdown-content menu p-2 shadow bg-base-100 rounded-box mt-4 w-52"
              role="menu"
            >
              <li className="text-[15px] text-[#000] py-1">
